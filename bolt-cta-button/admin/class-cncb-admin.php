...
class CNCB_Admin {
	...
	private function sanitize_options( $data ) {
		...
		$sanitized['bar_shadow'] = isset( $data['bar_shadow'] ) && in_array( $data['bar_shadow'], array( 'none', 'sm', 'md', 'lg' ), true )
			? $data['bar_shadow']
			: $defaults['bar_shadow'];

		$sanitized['bar_button_shadow'] = isset( $data['bar_button_shadow'] ) && in_array( $data['bar_button_shadow'], array( 'none', 'sm', 'md', 'lg' ), true )
			? $data['bar_button_shadow']
			: $defaults['bar_button_shadow'];
		...
		$sanitized['fab_animation'] = isset( $data['fab_animation'] ) && in_array( $data['fab_animation'], array( 'none', 'pulse', 'glow', 'bounce', 'shake' ), true )
			? $data['fab_animation']
			: $defaults['fab_animation'];

		$sanitized['fab_shadow'] = isset( $data['fab_shadow'] ) && in_array( $data['fab_shadow'], array( 'none', 'sm', 'md', 'lg' ), true )
			? $data['fab_shadow']
			: $defaults['fab_shadow'];
		...
		<div class="wrap cncb-admin-wrap">
			...
			<div class="cncb-admin-container">
				...
				<div class="cncb-admin-main">
						...
						<div id="cncb-tab-design" class="cncb-tab-panel">
							...
							<div class="cncb-card cncb-panel-bar" data-show-when="bar">
								...
								<table class="form-table">
									...
									<tr>
										<th><?php esc_html_e( 'Bar Shadow', 'bolt-cta-button' ); ?></th>
										<td>
											<select id="cncb-bar-shadow">
												<option value="none" <?php selected( $options['bar_shadow'], 'none' ); ?>><?php esc_html_e( 'None', 'bolt-cta-button' ); ?></option>
												<option value="sm" <?php selected( $options['bar_shadow'], 'sm' ); ?>><?php esc_html_e( 'Small', 'bolt-cta-button' ); ?></option>
												<option value="md" <?php selected( $options['bar_shadow'], 'md' ); ?>><?php esc_html_e( 'Medium', 'bolt-cta-button' ); ?></option>
												<option value="lg" <?php selected( $options['bar_shadow'], 'lg' ); ?>><?php esc_html_e( 'Large', 'bolt-cta-button' ); ?></option>
											</select>
											<p class="description"><?php esc_html_e( 'Shadow behind the bar background.', 'bolt-cta-button' ); ?></p>
										</td>
									</tr>
									<tr>
										<th><?php esc_html_e( 'Button Shadow', 'bolt-cta-button' ); ?></th>
										<td>
											<select id="cncb-bar-button-shadow">
												<option value="none" <?php selected( $options['bar_button_shadow'], 'none' ); ?>><?php esc_html_e( 'None', 'bolt-cta-button' ); ?></option>
												<option value="sm" <?php selected( $options['bar_button_shadow'], 'sm' ); ?>><?php esc_html_e( 'Small', 'bolt-cta-button' ); ?></option>
												<option value="md" <?php selected( $options['bar_button_shadow'], 'md' ); ?>><?php esc_html_e( 'Medium', 'bolt-cta-button' ); ?></option>
												<option value="lg" <?php selected( $options['bar_button_shadow'], 'lg' ); ?>><?php esc_html_e( 'Large', 'bolt-cta-button' ); ?></option>
											</select>
											<p class="description"><?php esc_html_e( 'Shadow on each individual button.', 'bolt-cta-button' ); ?></p>
										</td>
									</tr>
								</table>
							</div>
								...
								<table class="form-table">
									...
									<tr>
										...
										<td>
											...
											<p class="description"><?php esc_html_e( 'Animation for sub-buttons when FAB is opened.', 'bolt-cta-button' ); ?></p>
										</td>
									</tr>
									<tr>
										<th><?php esc_html_e( 'Button Animation', 'bolt-cta-button' ); ?></th>
										<td>
											<select id="cncb-fab-animation">
												<option value="none" <?php selected( $options['fab_animation'], 'none' ); ?>><?php esc_html_e( 'None', 'bolt-cta-button' ); ?></option>
												<option value="pulse" <?php selected( $options['fab_animation'], 'pulse' ); ?>><?php esc_html_e( 'Pulse', 'bolt-cta-button' ); ?></option>
												<option value="glow" <?php selected( $options['fab_animation'], 'glow' ); ?>><?php esc_html_e( 'Glow', 'bolt-cta-button' ); ?></option>
												<option value="bounce" <?php selected( $options['fab_animation'], 'bounce' ); ?>><?php esc_html_e( 'Bounce', 'bolt-cta-button' ); ?></option>
												<option value="shake" <?php selected( $options['fab_animation'], 'shake' ); ?>><?php esc_html_e( 'Shake', 'bolt-cta-button' ); ?></option>
											</select>
											<p class="description"><?php esc_html_e( 'Idle animation on the main FAB button.', 'bolt-cta-button' ); ?></p>
										</td>
									</tr>
									<tr>
										<th><?php esc_html_e( 'Shadow', 'bolt-cta-button' ); ?></th>
										<td>
											<select id="cncb-fab-shadow">
												<option value="none" <?php selected( $options['fab_shadow'], 'none' ); ?>><?php esc_html_e( 'None', 'bolt-cta-button' ); ?></option>
												<option value="sm" <?php selected( $options['fab_shadow'], 'sm' ); ?>><?php esc_html_e( 'Small', 'bolt-cta-button' ); ?></option>
												<option value="md" <?php selected( $options['fab_shadow'], 'md' ); ?>><?php esc_html_e( 'Medium', 'bolt-cta-button' ); ?></option>
												<option value="lg" <?php selected( $options['fab_shadow'], 'lg' ); ?>><?php esc_html_e( 'Large', 'bolt-cta-button' ); ?></option>
											</select>
										</td>
									</tr>
									<tr>
					...
					<!-- Reset to Defaults -->
					<div class="cncb-card cncb-reset-card">
						<h2><?php esc_html_e( 'Reset Settings', 'bolt-cta-button' ); ?></h2>
						<p class="description">
							<?php esc_html_e( 'Restore all plugin settings to their original defaults. Your saved buttons, design, display rules, and other preferences will be erased. This cannot be undone.', 'bolt-cta-button' ); ?>
						</p>
						<button type="button" id="cncb-reset-options" class="button cncb-btn-danger"
							data-confirm="<?php echo esc_attr__( 'Are you sure? All settings will be restored to defaults. This action cannot be undone.', 'bolt-cta-button' ); ?>"
							data-resetting="<?php echo esc_attr__( 'Resetting...', 'bolt-cta-button' ); ?>"
							data-success="<?php echo esc_attr__( 'Settings reset. Reloading...', 'bolt-cta-button' ); ?>"
							data-error="<?php echo esc_attr__( 'Error resetting settings.', 'bolt-cta-button' ); ?>"
							data-nonce="<?php echo esc_attr( wp_create_nonce( 'cncb_reset_options_nonce' ) ); ?>">
							<?php esc_html_e( 'Reset to Defaults', 'bolt-cta-button' ); ?>
						</button>
						<span id="cncb-reset-options-status"></span>
					</div>
